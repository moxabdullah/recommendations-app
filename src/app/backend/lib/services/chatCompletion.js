...
const query = "I feel sad. I want something funny and joyful"
const chatMessages = [{
    role: "system",
...
const userQueryEmbedding = await createUserQueryEmbedding(query)
const matchUserQuery = await findNearestMatch(userQueryEmbedding)
// const modelOutput = await getChatCompletion(matchUserQuery, userQuery)
